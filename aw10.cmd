@echo off
title Aktivasi Windows 10 Tanpa Software !
cls
setlocal ENABLEDELAYEDEXPANSION

echo.
echo ========================================
echo    Windows 10 Activation Script
echo ========================================
echo.
...
echo.
echo =====================================================================================
echo    [PROSES] Mengaktivasi Windows 10 Anda, silahkan tunggu...
echo =====================================================================================
echo.
...
:: Periksa apakah Windows Script Host diaktifkan
...
:: Deteksi versi Windows dan pasang kunci produk yang sesuai
wmic os | findstr /I "enterprise" >nul
if !errorlevel! EQU 0 (
    echo [PROSES] Mendeteksi Windows 10 Enterprise...
...
if !errorlevel! EQU 0 (
    echo [PROSES] Mendeteksi Windows 10 Home...
...
if !errorlevel! EQU 0 (
    echo [PROSES] Mendeteksi Windows 10 Education...
...
if !errorlevel! EQU 0 (
    echo [PROSES] Mendeteksi Windows 10 Pro...
...
echo [PROSES] Menghubungkan ke server KMS...
...
echo =====================================================================================
echo.
echo [GALAT] Maaf, Windows 10 Anda tidak didukung oleh skrip ini.
echo.
goto halt
