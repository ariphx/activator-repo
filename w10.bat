@echo off
title Activate Windows 10 ALL versions
cls
...
if !errorlevel! EQU 0 (
    echo [PROSES] Windows 10 Enterprise detected. Installing GVLK...
...
if !errorlevel! EQU 0 (
    echo [PROSES] Windows 10 Home detected. Installing GVLK...
...
if !errorlevel! EQU 0 (
    echo [PROSES] Windows 10 Education detected. Installing GVLK...
...
if !errorlevel! EQU 0 (
    echo [PROSES] Windows 10 Pro detected. Installing GVLK...
