@echo off
title Activate Microsoft Office 2021 Without Software - Ariphx
cls
setlocal ENABLEDELAYEDEXPANSION

echo.
echo ================================================
echo    Microsoft Office 2021 Activation Script
echo ================================================
echo.
...
echo.
echo =====================================================================================
echo    [PROSES] Mengaktivasi Office 2021 Anda, silahkan tunggu...
echo =====================================================================================
echo.
...
echo.
echo =====================================================================================
echo    [PROSES] Mengaktivasi Office 2021, mohon tunggu...
echo =====================================================================================
echo.
...
cscript //nologo ospp.vbs /act | find /i "successful" && (
    ...
    echo.
    echo Support us by donating via trakteer.id/ariphx so this method can continue to be used.
    echo.
    timeout /t 7 >nul
...
echo =====================================================================================
echo.
echo [GALAT] Maaf, Office 2021 Anda tidak didukung.
echo.
goto halt
